...
// Hàm hiển thị chữ "HAPPY NEW YEAR"
function showHappyNewYear() {
    const happyNewYear = document.getElementById('happy-new-year');
    happyNewYear.classList.add('visible'); // Thêm lớp để hiển thị chữ
}
// Hàm hiển thị chữ "HAPPY NEW YEAR"
function showHappyNewYear() {
    const happyNewYear = document.getElementById('happy-new-year');
...
// Hàm ẩn "HAPPY NEW YEAR"
function hideHappyNewYear() {
    const happyNewYear = document.getElementById('happy-new-year');
    happyNewYear.classList.remove('visible'); // Loại bỏ lớp để ẩn chữ
}

// Hàm hiển thị câu chúc Tết
function showTetGreeting() {
    const tetGreeting = document.getElementById('tet-greeting');
    tetGreeting.classList.add('visible'); // Thêm lớp để hiển thị câu chúc
}

// Hàm ẩn câu chúc Tết
function hideTetGreeting() {
    const tetGreeting = document.getElementById('tet-greeting');
    tetGreeting.classList.remove('visible'); // Loại bỏ lớp để ẩn câu chúc
}

// Sau khi bắn pháo hoa bắt đầu, hiển thị chữ "HAPPY NEW YEAR"
setTimeout(() => {
    showHappyNewYear();
    // Ẩn "HAPPY NEW YEAR" sau 3 giây
    setTimeout(() => {
        hideHappyNewYear();
        // Hiển thị câu chúc Tết sau 3 giây
        setTimeout(() => {
            showTetGreeting();
            // Ẩn câu chúc Tết sau 3 giây
            setTimeout(() => {
                hideTetGreeting();
            }, 10000); // 3000ms = 3 giây
        }, 3000); // Sau 3 giây ẩn "HAPPY NEW YEAR"
    }, 3000); // 3000ms = 3 giây hiển thị "HAPPY NEW YEAR"
}, 5000); // 3000ms = 3 giây sau khi bắn pháo hoa
